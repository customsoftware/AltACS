...
extension TaskFactory {
    static func generatePreFlightPreparationTasks(for aSection: TestSection, in context: ModelContext) -> [Task] {
        ...
        /// Creaete components here
        TaskFactory.createComponent(type: .knowledge, id: "PA.I.E.K1", "Elements related to performance and limitations by explaining the use of charts, tables, and data to determine performance.", in: task6, using: context)
        TaskFactory.createComponent(type: .knowledge, id: "PA.I.E.K2", "Factors affecting performance, to include:", in: task6, using: context)
        TaskFactory.createComponent(type: .knowledge, id: "PA.I.E.K2a", "a. Atmospheric conditions", in: task6, using: context)
        TaskFactory.createComponent(type: .knowledge, id: "PA.I.E.K2b", "b. Pilot technique", in: task6, using: context)
        TaskFactory.createComponent(type: .knowledge, id: "PA.I.E.K2c", "c. Airplane configuration", in: task6, using: context)
        TaskFactory.createComponent(type: .knowledge, id: "PA.I.E.K2d", "d. Airport environment", in: task6, using: context)
        TaskFactory.createComponent(type: .knowledge, id: "PA.I.E.K2e", "e. Loading (e.g., center of gravity)", in: task6, using: context)
        TaskFactory.createComponent(type: .knowledge, id: "PA.I.E.K2f", "f. Weight and balance", in: task6, using: context)
        TaskFactory.createComponent(type: .knowledge, id: "PA.I.E.K3", "Aerodynamics.", in: task6, using: context)
        
        TaskFactory.createComponent(type: .risk, id: "PA.I.E.R1", "Inaccurate use of manufacturer’s performance charts, tables, and data.", in: task6, using: context)
        TaskFactory.createComponent(type: .risk, id: "PA.I.E.R2", "Exceeding airplane limitations.", in: task6, using: context)
        TaskFactory.createComponent(type: .risk, id: "PA.I.E.R3", "Possible differences between calculated performance and actual performance.", in: task6, using: context)
        
        TaskFactory.createComponent(type: .skill, id: "PA.I.E.S1", "Compute the weight and balance, correct out-of-center of gravity (CG) loading errors and determine if the weight and balance remains within limits during all phases of flight.", in: task6, using: context)
        TaskFactory.createComponent(type: .skill, id: "PA.I.E.S2", "Utilize the appropriate airplane manufacturer’s approved performance charts, tables, and data.", in: task6, using: context)
        ...
        /// Creaete components here
        TaskFactory.createComponent(type: .knowledge, id: "PA.I.F.K1", "Airplane systems, to include: (at least 3 of the following)", in: task7, using: context)
        TaskFactory.createComponent(type: .knowledge, id: "PA.I.F.K1a", "a. Primary flight controls", in: task7, using: context)
        TaskFactory.createComponent(type: .knowledge, id: "PA.I.F.K1b", "b. Secondary flight controls", in: task7, using: context)
        TaskFactory.createComponent(type: .knowledge, id: "PA.I.F.K1c", "c. Powerplant and propeller", in: task7, using: context)
        TaskFactory.createComponent(type: .knowledge, id: "PA.I.F.K1d", "d. Landing gear", in: task7, using: context)
        TaskFactory.createComponent(type: .knowledge, id: "PA.I.F.K1e", "e. Fuel, oil, and hydraulic", in: task7, using: context)
        TaskFactory.createComponent(type: .knowledge, id: "PA.I.F.K1f", "f. Electrical", in: task7, using: context)
        TaskFactory.createComponent(type: .knowledge, id: "PA.I.F.K1g", "g. Avionics", in: task7, using: context)
        TaskFactory.createComponent(type: .knowledge, id: "PA.I.F.K1h", "h. Pitot-static, vacuum/pressure, and associated flight instruments", in: task7, using: context)
        TaskFactory.createComponent(type: .knowledge, id: "PA.I.F.K1i", "i. Environmental", in: task7, using: context)
        TaskFactory.createComponent(type: .knowledge, id: "PA.I.F.K1j", "j. Deicing and anti-icing", in: task7, using: context)
        TaskFactory.createComponent(type: .knowledge, id: "PA.I.F.K1k", "k. Water rudders (ASES, AMES)", in: task7, using: context)
        TaskFactory.createComponent(type: .knowledge, id: "PA.I.F.K1l", "l. Oxygen system", in: task7, using: context)
        TaskFactory.createComponent(type: .knowledge, id: "PA.I.F.K2", "Indications of and procedures for managing system abnormalities or failures.", in: task7, using: context)
        
        TaskFactory.createComponent(type: .risk, id: "PA.I.F.R1", "Failure to detect system malfunctions or failures.", in: task7, using: context)
        TaskFactory.createComponent(type: .risk, id: "PA.I.F.R2", "Improper management of a system failure.", in: task7, using: context)
        TaskFactory.createComponent(type: .risk, id: "PA.I.F.R3", "Failure to monitor and manage automated systems.", in: task7, using: context)
        
        TaskFactory.createComponent(type: .skill, id: "PA.I.F.S1", "Operate at least three of the systems listed in K1a through K1l above appropriately.", in: task7, using: context)
        TaskFactory.createComponent(type: .skill, id: "PA.I.F.S2", "Use appropriate checklists properly.", in: task7, using: context)
